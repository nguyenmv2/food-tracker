...
#
#   https://github.com/sorbet/sorbet-typed/new/master?filename=lib/nokogiri-1.11.7-x86_64/all/nokogiri-1.11.7-x86_64.rbi
#
...
class Nokogiri::XML::SAX::Parser::Attribute < Anonymous_Struct_33
end
...
class Nokogiri::XML::Notation < Anonymous_Struct_34
end
...
class Nokogiri::HTML::EntityDescription < Anonymous_Struct_35
end
